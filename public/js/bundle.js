...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dino = __webpack_require__(452);
	 ...
	 */
	(0, _reactDom.render)(_react2.default.createElement(_Dino2.default, null), document.getElementById('main')); // required to support all ES6 features
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dino = function (_Component) {
		_inherits(Dino, _Component);
	  ...
	  */
		...
		function Dino(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Dino).call(this, props));
			...
			_this.onClick = function (e) {
				...
				_this.setState({ something: !_this.state.something });
			};
		...
		_createClass(Dino, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement("form", { action: "/file-upload", className: "dropzone", encType: "multipart/form-data", method: "post" })
				);
			}
		}]);
